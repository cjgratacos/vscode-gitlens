// 'use strict';
// import { ConfigurationChangeEvent, Disposable, Event, EventEmitter, TextDocument, TextEditor, workspace } from 'vscode';
...
//     //     if (this._context.editor === undefined || key !== this.git.toStateKey(this._context.editor.document.uri)) return;
...
//     async updateContext(reason: BlameabilityChangeReason, editor: TextEditor | undefined, force: boolean = false) {
//         try {
//             // let dirty = false;
//             let revision = false;
//             let tracked = false;
